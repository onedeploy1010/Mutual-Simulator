...
export const translations = {
  en: {
    ...
    shortTerm: 'Basic RWA',
    shortTermDesc: '5-10 days, 0.5%-1% daily, principal returned at 5%',
    longTerm: 'Custom RWA',
    longTermDesc: '180 days, 1%-1.5% daily, principal returned at day 180',
    ...
    cases: 'Cases',
    casesDesc: 'Learn how to build your team structure for each tier',
    caseStudy: 'Case Study',
    baseParams: 'Parameters',
    customRwaRate: 'Custom RWA Rate',
    streamingRateSetting: 'Streaming Rate',
    myInvestment: 'My Investment',
    directReferrals: 'Direct Referrals',
    indirectReferrals: 'Indirect Referrals',
    totalInvestment: 'Total Investment',
    teamPerformance: 'Team Performance',
    customRwaDividend: 'Custom RWA Dividend',
    streamingReward: 'Streaming Reward',
    directReferralReward: 'Direct Referral',
    indirectReferralReward: 'Indirect Referral',
    teamReward: 'Team Reward',
    streamingManagementReward: 'Streaming Mgmt',
    totalDailyIncome: 'Total Daily Income',
    dailyRatio: 'Daily Ratio',
    monthlyIncome: 'Monthly Income',
    total180DayProfit: '180-Day Profit',
    paybackPeriod: 'Payback Period',
    addAccount: 'Add Account',
    removeAccount: 'Remove Account',
    addLevel: 'Add Level',
    rwaAmount: 'RWA Amount',
    vipCase: 'VIP Case',
    star1Case: '1-Star Case',
    star2Case: '2-Star Case',
    star3Case: '3-Star Case',
    incomeBreakdown: 'Income Breakdown',
    structureOverview: 'Structure Overview',
    viewStructure: 'View Structure',
    viewCalculation: 'View Calculation',
    accounts: 'accounts',
    eachInvests: 'each invests',
    selfInvestment: 'Self',
    level1: 'Level 1',
    level2: 'Level 2',
    level3: 'Level 3',
  ...
  zh: {
    ...
    productType: '产品类型',
    shortTerm: '基础RWA',
    shortTermDesc: '周期5-10天，每日0.5%-1%，满5%返还本金',
    longTerm: '定制RWA',
    longTermDesc: '周期180天，每日1%-1.5%，满180天返还本金',
    ...
    cases: '案例',
    casesDesc: '学习如何为每个级别构建团队结构',
    caseStudy: '案例研究',
    baseParams: '参数设置',
    customRwaRate: '定制RWA收益率',
    streamingRateSetting: '推流利率',
    myInvestment: '自己投资',
    directReferrals: '直推下级',
    indirectReferrals: '间推下级',
    totalInvestment: '总投资',
    teamPerformance: '团队业绩',
    customRwaDividend: '定制RWA分红',
    streamingReward: '推流奖励',
    directReferralReward: '直推奖励',
    indirectReferralReward: '间推奖励',
    teamReward: '团队奖励',
    streamingManagementReward: '推流管理奖励',
    totalDailyIncome: '总日收入',
    dailyRatio: '日收益比例',
    monthlyIncome: '月收入',
    total180DayProfit: '180天总利润',
    paybackPeriod: '回本期',
    addAccount: '增加户口',
    removeAccount: '删除户口',
    addLevel: '增加层级',
